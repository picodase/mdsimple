...
then
    ...
    gmx grompp -maxwarn 3 -f NVT_fixed_atoms.mdp -c em.gro -p topol.top -o nvt_constrained.tpr
    echo " "
...
then
    ...
    gmx grompp -maxwarn 3 -f NPT.mdp -c npt_constrained.gro -t npt_constrained.cpt -p topol.top -o md_0_1.tpr
    echo " "
