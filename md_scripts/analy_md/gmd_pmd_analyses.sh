...
gmx trjconv -s md_0_1.tpr -f md_0_1.xtc -o md_0_1_ctr_noPBC.xtc -pbc mol -center
...
gmx trjconv -f md_0_1_ctr_noPBC.xtc -s md_0_1.tpr -o md_0_1_processed.pdb -fit rot+trans
...
# Center the PDB trajectory
gmx trjconv -s md_0_1.pdb -o md_0_1_ctr_noPBC.pdb -pbc mol -center
